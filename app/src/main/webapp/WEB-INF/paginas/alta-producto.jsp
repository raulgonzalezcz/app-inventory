...
<div class="card card-container">
	...
	<s:if test="%{producto.marca==null}">
	        <s:form action="altaproducto" namespace="/actions/socios" method="POST" class="form-signin">
				...
				<p>Precio de venta:</p>
				<s:textfield  type="number" name="producto.precio_venta" class="form-control" placeholder="..." required="required"></s:textfield>
				<p>Descuento:</p>
				<s:textfield  type="number" name="producto.descuento" class="form-control" placeholder="..." required="required"></s:textfield>
				<p>Descripción:</p>
				<s:textarea name="producto.descripcion" maxlength="50" class="form-control" placeholder="..." required="required"></s:textarea>
				<p>Cantidad:</p>
				<s:textfield type="number" name="producto.cantidad" class="form-control" placeholder="..." required="required"></s:textfield>
				<p>Foto:</p>
